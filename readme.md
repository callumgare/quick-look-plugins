...
Run `brew cask install qlimagesize` [(more info)](https://github.com/Homebrew/homebrew-cask/pull/59162) or [download manually](https://github.com/Nyx0uf/qlImageSize#installation)
